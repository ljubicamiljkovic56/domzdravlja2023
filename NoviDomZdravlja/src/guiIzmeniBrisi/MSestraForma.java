...
public class MSestraForma extends JFrame {
	...
	public MSestraForma(Liste liste, MedicinskaSestra mSestra) {
		this.liste = liste;
		...
		btnOK.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				if(validacija() == true) {
					...
					liste.snimiSestru();
					MSestraForma.this.dispose();
					MSestraForma.this.setVisible(false);
				}else {
